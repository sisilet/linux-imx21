...
static void imxfb_setup_gpio(struct imxfb_info *fbi)
{
	...
	imx_gpio_mode(PD6_PF_LSCLK);
        ...
        /* Used for compact flash on CSB536FS */
	imx_gpio_mode(PD10_PF_SPL_SPR);
	imx_gpio_mode(PD7_PF_REV);
/	imx_gpio_mode(PD8_PF_CLS);

        /* Used for VEE control on CSB536 */
...
#if (!defined(CONFIG_MACH_PIMX1) && !defined(CONFIG_MACH_CSB536))
	/* 
         * on PiMX1 used as buffers enable signal
         * On CSB536 used for Compact Flash
	 */
