...
#define isp116x_show_reg(s,d,r) {				\
	if ((r) < 0x20) {			                \
                if (s) seq_printf(s, "%-12s[%02x]: %08x\n",     \
                        #r, r, isp116x_read_reg32(d, r));       \
                else DBG("%-12s[%02x]: %08x\n", #r,		\
                        r, isp116x_read_reg32(d, r));           \
	} else {                                                \
                if (s) seq_printf(s, "%-12s[%02x]:     %04x\n", \
                        #r, r, isp116x_read_reg16(d, r));       \
                else DBG("%-12s[%02x]:     %04x\n", #r,		\
			r, isp116x_read_reg16(d, r));	    	\
	}							\
}

static inline void isp116x_show_regs(struct seq_file *s, struct isp116x *isp116x)
{
	isp116x_show_reg(s, isp116x, HCREVISION);
	isp116x_show_reg(s, isp116x, HCCONTROL);
	isp116x_show_reg(s, isp116x, HCCMDSTAT);
	isp116x_show_reg(s, isp116x, HCINTSTAT);
	isp116x_show_reg(s, isp116x, HCINTENB);
	isp116x_show_reg(s, isp116x, HCFMINTVL);
	isp116x_show_reg(s, isp116x, HCFMREM);
	isp116x_show_reg(s, isp116x, HCFMNUM);
	isp116x_show_reg(s, isp116x, HCLSTHRESH);
	isp116x_show_reg(s, isp116x, HCRHDESCA);
	isp116x_show_reg(s, isp116x, HCRHDESCB);
	isp116x_show_reg(s, isp116x, HCRHSTATUS);
	isp116x_show_reg(s, isp116x, HCRHPORT1);
	isp116x_show_reg(s, isp116x, HCRHPORT2);
	isp116x_show_reg(s, isp116x, HCHWCFG);
	isp116x_show_reg(s, isp116x, HCDMACFG);
	isp116x_show_reg(s, isp116x, HCXFERCTR);
	isp116x_show_reg(s, isp116x, HCuPINT);
	isp116x_show_reg(s, isp116x, HCuPINTENB);
	isp116x_show_reg(s, isp116x, HCCHIPID);
	isp116x_show_reg(s, isp116x, HCSCRATCH);
	isp116x_show_reg(s, isp116x, HCITLBUFLEN);
	isp116x_show_reg(s, isp116x, HCATLBUFLEN);
	isp116x_show_reg(s, isp116x, HCBUFSTAT);
	isp116x_show_reg(s, isp116x, HCRDITL0LEN);
	isp116x_show_reg(s, isp116x, HCRDITL1LEN);
}
