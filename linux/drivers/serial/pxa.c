...
static struct uart_pxa_port serial_pxa_ports[] = {
	...
	.port	= {
		...
		.fifosize	= 64,
		.ops		= &serial_pxa_pops,
		.line		= CONFIG_ASSIGNMENT_FFUART,
	},
     }, 
     [CONFIG_ASSIGNMENT_BTUART] = {
	.name	= "BTUART",
	.cken	= CKEN7_BTUART,
	.port	= {
		.type		= PORT_PXA,
		...
		.fifosize	= 64,
		.ops		= &serial_pxa_pops,
		.line		= CONFIG_ASSIGNMENT_BTUART,
	},
     },
     [CONFIG_ASSIGNMENT_STUART] = {
	.name	= "STUART",
	.cken	= CKEN5_STUART,
	.port	= {
		.type		= PORT_PXA,
